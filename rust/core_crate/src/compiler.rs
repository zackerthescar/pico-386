...
impl Compiler {
    ...
    fn global_slot(&mut self, n: Name) -> u8 {
        match self.name_bytes(n) {
            ...
            b"abs" => P386_BUILTIN_ABS,
            b"flr" => P386_BUILTIN_FLR,
            b"ceil" => P386_BUILTIN_CEIL,
            b"sgn" => P386_BUILTIN_SGN,
            b"min" => P386_BUILTIN_MIN,
            b"max" => P386_BUILTIN_MAX,
            b"mid" => P386_BUILTIN_MID,
            b"sqrt" => P386_BUILTIN_SQRT,
            b"sin" => P386_BUILTIN_SIN,
            b"cos" => P386_BUILTIN_COS,
            b"atan2" => P386_BUILTIN_ATAN2,
            b"rnd" => P386_BUILTIN_RND,
            b"srand" => P386_BUILTIN_SRAND,
            b"band" => P386_BUILTIN_BAND,
            b"bor" => P386_BUILTIN_BOR,
            b"bxor" => P386_BUILTIN_BXOR,
            b"bnot" => P386_BUILTIN_BNOT,
            b"shl" => P386_BUILTIN_SHL,
            b"shr" => P386_BUILTIN_SHR,
            b"lshr" => P386_BUILTIN_LSHR,
            b"rotl" => P386_BUILTIN_ROTL,
            b"rotr" => P386_BUILTIN_ROTR,
            b"peek" => P386_BUILTIN_PEEK,
            b"poke" => P386_BUILTIN_POKE,
            b"peek2" => P386_BUILTIN_PEEK2,
            b"poke2" => P386_BUILTIN_POKE2,
            b"peek4" => P386_BUILTIN_PEEK4,
            b"poke4" => P386_BUILTIN_POKE4,
            b"add" => P386_BUILTIN_ADD,
            b"del" => P386_BUILTIN_DEL,
            b"deli" => P386_BUILTIN_DELI,
            b"count" => P386_BUILTIN_COUNTF,
            b"tostr" | b"tostring" => P386_BUILTIN_TOSTR,
            b"tonum" => P386_BUILTIN_TONUM,
